...
const CreatePoint = () => {
    ...
    const [selecteUf, setSelectUf] = useState ('0');
    ...
    useEffect(() =>{
        ...
        axios.get<CityIBGE[]>(`https://servicodados.ibge.gov.br/api/v1/localidades/estados/${selecteUf}/municipios`)
        .then( response =>{
                ...
                <fieldset>
                    ...
                    <div className="field-group">
                        <div className="field">
                            ...
                            <select name="uf" id="uf" value= {selecteUf} onChange = {handleSelectUf}>
